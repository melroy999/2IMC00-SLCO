...
public class Test {
    ...
    private static class Q implements SLCO_Class {
        ...
        Q(int[] x, int i) {
            ...
            // Instantiate the state machine threads and pass on the class' lock manager.
            T_SM1 = new Q_SM1Thread(lockManager);
        }
        ...
        // Representation of the SLCO state machine SM1.
        class Q_SM1Thread extends Thread implements Q_SM1Thread_States {
            // Current state
            private Q_SM1Thread.States currentState;
            ...
            Q_SM1Thread(LockManager lockManagerInstance) {
                currentState = Q_SM1Thread.States.SMC0;
                lockManager = lockManagerInstance;
                lock_ids = new int[2];
                target_locks = new int[2];
                random = new Random();
            ...
            private boolean execute_transition_SMC0_0() {
                ...
                currentState = Q_SM1Thread.States.SMC1;
                return true;
            }

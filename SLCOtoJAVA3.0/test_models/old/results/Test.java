...
public class Test {
    ...
    private static class P implements SLCO_Class {
        ...
        P(int[] x, int i) {
            ...
            T_SM2a = new P_SM2aThread(lockManager);
        ...
        // Define the states fot the state machine SM2a.
        interface P_SM2aThread_States {
            enum States {
                SMC0, 
                SMC1
            }
        ...
        // Representation of the SLCO state machine SM2a.
        class P_SM2aThread extends Thread implements P_SM2aThread_States {
            // Current state
            private P_SM2aThread.States currentState;
            ...
            P_SM2aThread(LockManager lockManagerInstance) {
                currentState = P_SM2aThread.States.SMC0;
                lockManager = lockManagerInstance;
                lock_ids = new int[2];
                target_locks = new int[2];
                random = new Random();

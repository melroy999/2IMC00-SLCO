package testing.randompickvariable.logging;
...
public class Telephony {
    ...
    static {
        ...
        String log_settings = "[LA,T=30s,URP]";
    ...
    private static class GlobalClass implements SLCO_Class {
        ...
        class GlobalClass_User_0Thread extends Thread implements GlobalClass_User_0Thread_States {
            ...
            private boolean execute_transition_calling_3() {
                ...
                if(!(partner[0] != 0 && partner[0] != 4 && chan[partner[0]] != 255 && t_calling_3_s_0_n_0())) {
                    return false;
                }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                if(!(chan[partner[0]] == 255 || t_tpickup_1_s_0_n_0())) {
                    return false;
                }
                // SLCO assignment | dev := 1.
                dev = (1) & 0xff;
        ...
        class GlobalClass_User_1Thread extends Thread implements GlobalClass_User_1Thread_States {
            ...
            private boolean execute_transition_calling_3() {
                ...
                if(!(partner[1] != 1 && partner[1] != 4 && chan[partner[1]] != 255 && t_calling_3_s_0_n_0())) {
                    return false;
                }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                if(!(chan[partner[1]] == 255 || t_tpickup_1_s_0_n_0())) {
                    return false;
                }
                // SLCO assignment | dev := 1.
                dev = (1) & 0xff;
        ...
        class GlobalClass_User_2Thread extends Thread implements GlobalClass_User_2Thread_States {
            ...
            private boolean execute_transition_calling_3() {
                ...
                if(!(partner[2] != 2 && partner[2] != 4 && chan[partner[2]] != 255 && t_calling_3_s_0_n_0())) {
                    return false;
                }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                if(!(chan[partner[2]] == 255 || t_tpickup_1_s_0_n_0())) {
                    return false;
                }
                // SLCO assignment | dev := 1.
                dev = (1) & 0xff;
        ...
        class GlobalClass_User_3Thread extends Thread implements GlobalClass_User_3Thread_States {
            ...
            private boolean execute_transition_calling_3() {
                ...
                if(!(partner[3] != 3 && partner[3] != 4 && chan[partner[3]] != 255 && t_calling_3_s_0_n_0())) {
                    return false;
                }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                if(!(chan[partner[3]] == 255 || t_tpickup_1_s_0_n_0())) {
                    return false;
                }
                // SLCO assignment | dev := 1.
                dev = (1) & 0xff;

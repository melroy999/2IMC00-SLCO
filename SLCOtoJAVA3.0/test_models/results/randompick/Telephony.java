    ...
    private static class GlobalClass implements SLCO_Class {
        ...
        class GlobalClass_User_0Thread extends Thread implements GlobalClass_User_0Thread_States {
            ...
            private boolean t_qi_0_s_0_n_0() {
                lock_ids[0] = target_locks[1] = 8 + 0; // Acquire partner[0]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[0]; // Acquire chan[partner[0]]
                lockManager.acquire_locks(lock_ids, 1);
                if((Math.floorMod(chan[partner[0]], 20)) == 0) {
                    lock_ids[0] = target_locks[0]; // Release chan[partner[0]]
                    lock_ids[1] = target_locks[1]; // Release partner[0]
                    lockManager.release_locks(lock_ids, 2);
                    return true;
                }
            ...
            private boolean t_calling_0_s_0_n_0() {
                lock_ids[0] = target_locks[1] = 0 + 0; // Acquire callforwardbusy[0]
                lock_ids[1] = target_locks[2] = 0 + 1; // Acquire callforwardbusy[1]
                lock_ids[2] = target_locks[3] = 0 + 2; // Acquire callforwardbusy[2]
                lock_ids[3] = target_locks[4] = 0 + 3; // Acquire callforwardbusy[3]
                lockManager.acquire_locks(lock_ids, 4);
                lock_ids[0] = target_locks[5] = 4 + 0; // Acquire record[0]
                lock_ids[1] = target_locks[6] = 4 + 1; // Acquire record[1]
                lock_ids[2] = target_locks[7] = 4 + 2; // Acquire record[2]
                lock_ids[3] = target_locks[8] = 4 + 3; // Acquire record[3]
                lockManager.acquire_locks(lock_ids, 4);
                lock_ids[0] = target_locks[0] = 8 + 0; // Acquire partner[0]
                lockManager.acquire_locks(lock_ids, 1);
                if(partner[0] == 0) {
                    lock_ids[0] = target_locks[0]; // Release partner[0]
                    lock_ids[1] = target_locks[1]; // Release callforwardbusy[0]
                    lock_ids[2] = target_locks[2]; // Release callforwardbusy[1]
                    lock_ids[3] = target_locks[3]; // Release callforwardbusy[2]
                    lock_ids[4] = target_locks[4]; // Release callforwardbusy[3]
                    lock_ids[5] = target_locks[5]; // Release record[0]
                    lock_ids[6] = target_locks[6]; // Release record[1]
                    lock_ids[7] = target_locks[7]; // Release record[2]
                    lock_ids[8] = target_locks[8]; // Release record[3]
            ...
            private boolean t_calling_3_s_0_n_2() {
                if(callforwardbusy[partner[0]] == 255) {
                    lock_ids[0] = target_locks[1]; // Release callforwardbusy[0]
                    lock_ids[1] = target_locks[2]; // Release callforwardbusy[1]
                    lock_ids[2] = target_locks[3]; // Release callforwardbusy[2]
                    lock_ids[3] = target_locks[4]; // Release callforwardbusy[3]
            ...
            private boolean execute_transition_calling_3() {
                ...
                lock_ids[0] = target_locks[0]; // Release partner[0]
                lock_ids[1] = target_locks[5]; // Release record[0]
                lock_ids[2] = target_locks[6]; // Release record[1]
                lock_ids[3] = target_locks[7]; // Release record[2]
                lock_ids[4] = target_locks[8]; // Release record[3]
            ...
            private boolean execute_transition_calling_4() {
                ...
                // SLCO assignment | record[partner[0]] := 0.
                record[partner[0]] = (0) & 0xff;
                lock_ids[0] = target_locks[5]; // Release record[0]
                lock_ids[1] = target_locks[6]; // Release record[1]
                lock_ids[2] = target_locks[7]; // Release record[2]
                lock_ids[3] = target_locks[8]; // Release record[3]
                lockManager.release_locks(lock_ids, 4);
            ...
            private boolean execute_transition_oconnected_0() {
                ...
                dev = (1) & 0xff;
                // SLCO assignment | chan[0] := 255.
                lock_ids[0] = target_locks[2] = 8 + 0; // Acquire partner[0]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[0]; // Acquire chan[partner[0]]
                lock_ids[1] = target_locks[1] = 12 + 0; // Acquire chan[0]
                ...
                lock_ids[0] = target_locks[0]; // Release chan[partner[0]]
                lock_ids[1] = target_locks[2]; // Release partner[0]
                lockManager.release_locks(lock_ids, 2);
            ...
            private boolean t_tpickup_1_s_0_n_1() {
                ...
                lock_ids[2] = target_locks[2]; // Release partner[0]
                lockManager.release_locks(lock_ids, 3);
                return false;
            }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                // SLCO assignment | partner[0] := 255.
                partner[0] = (255) & 0xff;
                lock_ids[0] = target_locks[2]; // Release partner[0]
                lockManager.release_locks(lock_ids, 1);
                // SLCO assignment | chan[0] := 255.
                chan[0] = (255) & 0xff;
                lock_ids[0] = target_locks[1]; // Release chan[0]
        ...
        class GlobalClass_User_1Thread extends Thread implements GlobalClass_User_1Thread_States {
            ...
            private boolean t_qi_0_s_0_n_0() {
                lock_ids[0] = target_locks[1] = 8 + 1; // Acquire partner[1]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[1]; // Acquire chan[partner[1]]
                lockManager.acquire_locks(lock_ids, 1);
                if((Math.floorMod(chan[partner[1]], 20)) == 1) {
                    lock_ids[0] = target_locks[0]; // Release chan[partner[1]]
                    lock_ids[1] = target_locks[1]; // Release partner[1]
                    lockManager.release_locks(lock_ids, 2);
                    return true;
                }
            ...
            private boolean execute_transition_oconnected_0() {
                ...
                dev = (1) & 0xff;
                // SLCO assignment | chan[1] := 255.
                lock_ids[0] = target_locks[2] = 8 + 1; // Acquire partner[1]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[1]; // Acquire chan[partner[1]]
                lock_ids[1] = target_locks[1] = 12 + 1; // Acquire chan[1]
                lockManager.acquire_locks(lock_ids, 2);
                chan[1] = (255) & 0xff;
                ...
                lock_ids[0] = target_locks[0]; // Release chan[partner[1]]
                lock_ids[1] = target_locks[2]; // Release partner[1]
                lockManager.release_locks(lock_ids, 2);
            ...
            private boolean t_tpickup_1_s_0_n_1() {
                ...
                lock_ids[2] = target_locks[2]; // Release partner[1]
                lockManager.release_locks(lock_ids, 3);
                return false;
            }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                // SLCO assignment | partner[1] := 255.
                partner[1] = (255) & 0xff;
                lock_ids[0] = target_locks[2]; // Release partner[1]
                lockManager.release_locks(lock_ids, 1);
                // SLCO assignment | chan[1] := 255.
                chan[1] = (255) & 0xff;
                lock_ids[0] = target_locks[1]; // Release chan[1]
        ...
        class GlobalClass_User_2Thread extends Thread implements GlobalClass_User_2Thread_States {
            ...
            private boolean t_qi_0_s_0_n_0() {
                lock_ids[0] = target_locks[1] = 8 + 2; // Acquire partner[2]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[2]; // Acquire chan[partner[2]]
                lockManager.acquire_locks(lock_ids, 1);
                if((Math.floorMod(chan[partner[2]], 20)) == 2) {
                    lock_ids[0] = target_locks[0]; // Release chan[partner[2]]
                    lock_ids[1] = target_locks[1]; // Release partner[2]
                    lockManager.release_locks(lock_ids, 2);
                    return true;
                }
            ...
            private boolean execute_transition_oconnected_0() {
                ...
                dev = (1) & 0xff;
                // SLCO assignment | chan[2] := 255.
                lock_ids[0] = target_locks[2] = 8 + 2; // Acquire partner[2]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[2]; // Acquire chan[partner[2]]
                lock_ids[1] = target_locks[1] = 12 + 2; // Acquire chan[2]
                lockManager.acquire_locks(lock_ids, 2);
                chan[2] = (255) & 0xff;
                ...
                lock_ids[0] = target_locks[0]; // Release chan[partner[2]]
                lock_ids[1] = target_locks[2]; // Release partner[2]
                lockManager.release_locks(lock_ids, 2);
            ...
            private boolean t_tpickup_1_s_0_n_1() {
                ...
                lock_ids[2] = target_locks[2]; // Release partner[2]
                lockManager.release_locks(lock_ids, 3);
                return false;
            }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                // SLCO assignment | partner[2] := 255.
                partner[2] = (255) & 0xff;
                lock_ids[0] = target_locks[2]; // Release partner[2]
                lockManager.release_locks(lock_ids, 1);
                // SLCO assignment | chan[2] := 255.
                chan[2] = (255) & 0xff;
                lock_ids[0] = target_locks[1]; // Release chan[2]
        ...
        class GlobalClass_User_3Thread extends Thread implements GlobalClass_User_3Thread_States {
            ...
            private boolean t_qi_0_s_0_n_0() {
                lock_ids[0] = target_locks[1] = 8 + 3; // Acquire partner[3]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[3]; // Acquire chan[partner[3]]
                lockManager.acquire_locks(lock_ids, 1);
                if((Math.floorMod(chan[partner[3]], 20)) == 3) {
                    lock_ids[0] = target_locks[0]; // Release chan[partner[3]]
                    lock_ids[1] = target_locks[1]; // Release partner[3]
                    lockManager.release_locks(lock_ids, 2);
                    return true;
                }
            ...
            private boolean execute_transition_oconnected_0() {
                ...
                dev = (1) & 0xff;
                // SLCO assignment | chan[3] := 255.
                lock_ids[0] = target_locks[2] = 8 + 3; // Acquire partner[3]
                lockManager.acquire_locks(lock_ids, 1);
                lock_ids[0] = target_locks[0] = 12 + partner[3]; // Acquire chan[partner[3]]
                lock_ids[1] = target_locks[1] = 12 + 3; // Acquire chan[3]
                lockManager.acquire_locks(lock_ids, 2);
                chan[3] = (255) & 0xff;
                ...
                lock_ids[0] = target_locks[0]; // Release chan[partner[3]]
                lock_ids[1] = target_locks[2]; // Release partner[3]
                lockManager.release_locks(lock_ids, 2);
            ...
            private boolean t_tpickup_1_s_0_n_1() {
                ...
                lock_ids[2] = target_locks[2]; // Release partner[3]
                lockManager.release_locks(lock_ids, 3);
                return false;
            }
            ...
            private boolean execute_transition_tpickup_1() {
                ...
                // SLCO assignment | partner[3] := 255.
                partner[3] = (255) & 0xff;
                lock_ids[0] = target_locks[2]; // Release partner[3]
                lockManager.release_locks(lock_ids, 1);
                // SLCO assignment | chan[3] := 255.
                chan[3] = (255) & 0xff;
                lock_ids[0] = target_locks[1]; // Release chan[3]

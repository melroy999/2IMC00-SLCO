    ...
    private static class GlobalClass implements SLCO_Class {
        ...
        class GlobalClass_User_0Thread extends Thread implements GlobalClass_User_0Thread_States {
            ...
            private boolean t_calling_3_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[0]; // Acquire chan[partner[0]]
                lockManager.acquire_locks(lock_ids, 1);
                if(chan[partner[0]] != 255) {
                    lock_ids[0] = target_locks[9]; // Release chan[partner[0]]
                    lockManager.release_locks(lock_ids, 1);
                    return true;
                }
                lock_ids[0] = target_locks[0]; // Release partner[0]
                ...
                lock_ids[7] = target_locks[7]; // Release callforwardbusy[2]
                lock_ids[8] = target_locks[8]; // Release callforwardbusy[3]
                lock_ids[9] = target_locks[9]; // Release chan[partner[0]]
            ...
            private boolean execute_transition_calling_3() {
                ...
                if(!(t_calling_3_s_0_n_0() && t_calling_3_s_0_n_1() && t_calling_3_s_0_n_2() && t_calling_3_s_0_n_3())) {
                    return false;
                }
            ...
            private boolean t_calling_5_s_0_n_2() {
                ...
                lock_ids[3] = target_locks[3]; // Release record[2]
                lock_ids[4] = target_locks[4]; // Release record[3]
                lock_ids[5] = target_locks[9]; // Release chan[partner[0]]
                lock_ids[6] = target_locks[10]; // Release chan[0]
                lockManager.release_locks(lock_ids, 7);
                return false;
            }
            ...
            private boolean execute_transition_oalert_1() {
                ...
                if(!(t_oalert_1_s_0_n_0() && t_oalert_1_s_0_n_1())) {
                    return false;
                }
            ...
            private boolean execute_transition_tpickup_0() {
                ...
                if(!(t_tpickup_0_s_0_n_0() && t_tpickup_0_s_0_n_1())) {
                    return false;
                }
                // SLCO assignment | dev := 0.
                dev = (0) & 0xff;
            ...
            private boolean execute_transition_tconnected_0() {
                ...
                if(!(t_tconnected_0_s_0_n_0() && dev == 0)) {
                    return false;
                }
                // SLCO assignment | dev := 1.
                dev = (1) & 0xff;
            ...
            private boolean execute_transition_tconnected_1() {
                ...
                if(!(t_tconnected_1_s_0_n_0() && dev == 1)) {
                    return false;
                }
                // SLCO assignment | dev := 0.
                dev = (0) & 0xff;
        ...
        class GlobalClass_User_1Thread extends Thread implements GlobalClass_User_1Thread_States {
            ...
            private boolean t_calling_3_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[1]; // Acquire chan[partner[1]]
                lockManager.acquire_locks(lock_ids, 1);
                if(chan[partner[1]] != 255) {
                    lock_ids[0] = target_locks[9]; // Release chan[partner[1]]
                    lockManager.release_locks(lock_ids, 1);
                    return true;
                }
                lock_ids[0] = target_locks[0]; // Release partner[1]
                ...
                lock_ids[7] = target_locks[7]; // Release callforwardbusy[2]
                lock_ids[8] = target_locks[8]; // Release callforwardbusy[3]
                lock_ids[9] = target_locks[9]; // Release chan[partner[1]]
                lockManager.release_locks(lock_ids, 10);
                return false;
            }
            ...
            private boolean t_calling_5_s_0_n_2() {
                ...
                lock_ids[3] = target_locks[3]; // Release record[2]
                lock_ids[4] = target_locks[4]; // Release record[3]
                lock_ids[5] = target_locks[9]; // Release chan[partner[1]]
        ...
        class GlobalClass_User_2Thread extends Thread implements GlobalClass_User_2Thread_States {
            ...
            private boolean t_calling_3_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[2]; // Acquire chan[partner[2]]
                lockManager.acquire_locks(lock_ids, 1);
                if(chan[partner[2]] != 255) {
                    lock_ids[0] = target_locks[9]; // Release chan[partner[2]]
                    lockManager.release_locks(lock_ids, 1);
                    return true;
                }
                lock_ids[0] = target_locks[0]; // Release partner[2]
                ...
                lock_ids[7] = target_locks[7]; // Release callforwardbusy[2]
                lock_ids[8] = target_locks[8]; // Release callforwardbusy[3]
                lock_ids[9] = target_locks[9]; // Release chan[partner[2]]
                lockManager.release_locks(lock_ids, 10);
                return false;
            }
            ...
            private boolean t_calling_5_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[2]; // Acquire chan[partner[2]]
                lock_ids[1] = target_locks[10] = 12 + 2; // Acquire chan[2]
                lockManager.acquire_locks(lock_ids, 2);
                if(chan[partner[2]] == 255) {
                    return true;
                }
                ...
                lock_ids[3] = target_locks[3]; // Release record[2]
                lock_ids[4] = target_locks[4]; // Release record[3]
                lock_ids[5] = target_locks[9]; // Release chan[partner[2]]
                lock_ids[6] = target_locks[10]; // Release chan[2]
                lockManager.release_locks(lock_ids, 7);
                return false;
            }
            ...
            private boolean execute_transition_calling_5() {
                ...
                lock_ids[0] = target_locks[0]; // Release partner[2]
                lock_ids[1] = target_locks[10]; // Release chan[2]
                lockManager.release_locks(lock_ids, 2);
        ...
        class GlobalClass_User_3Thread extends Thread implements GlobalClass_User_3Thread_States {
            ...
            private boolean t_calling_3_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[3]; // Acquire chan[partner[3]]
                lockManager.acquire_locks(lock_ids, 1);
                if(chan[partner[3]] != 255) {
                    lock_ids[0] = target_locks[9]; // Release chan[partner[3]]
                    lockManager.release_locks(lock_ids, 1);
                    return true;
                }
                lock_ids[0] = target_locks[0]; // Release partner[3]
                ...
                lock_ids[7] = target_locks[7]; // Release callforwardbusy[2]
                lock_ids[8] = target_locks[8]; // Release callforwardbusy[3]
                lock_ids[9] = target_locks[9]; // Release chan[partner[3]]
                lockManager.release_locks(lock_ids, 10);
                return false;
            }
            ...
            private boolean t_calling_5_s_0_n_2() {
                lock_ids[0] = target_locks[9] = 12 + partner[3]; // Acquire chan[partner[3]]
                lock_ids[1] = target_locks[10] = 12 + 3; // Acquire chan[3]
                lockManager.acquire_locks(lock_ids, 2);
                if(chan[partner[3]] == 255) {
                    return true;
                }
                ...
                lock_ids[3] = target_locks[3]; // Release record[2]
                lock_ids[4] = target_locks[4]; // Release record[3]
                lock_ids[5] = target_locks[9]; // Release chan[partner[3]]
                lock_ids[6] = target_locks[10]; // Release chan[3]
                lockManager.release_locks(lock_ids, 7);
                return false;
            }
            ...
            private boolean execute_transition_calling_5() {
                ...
                lock_ids[0] = target_locks[0]; // Release partner[3]
                lock_ids[1] = target_locks[10]; // Release chan[3]
                lockManager.release_locks(lock_ids, 2);

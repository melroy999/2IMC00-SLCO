    ...
    private static class P implements SLCO_Class {
        ...
        class P_SM1Thread extends Thread implements P_SM1Thread_States {
            ...
            private void exec() {
                ...
                // Report all counts.
                logger.info("D0.O " + D0_O);
                logger.info("D0.F " + D0_F);
                logger.info("D0.S " + D0_S);
                logger.info("T0.O " + T0_O);
                logger.info("T0.F " + T0_F);
                logger.info("T0.S " + T0_S);
                logger.info("D1.O " + D1_O);
                logger.info("D1.F " + D1_F);
                logger.info("D1.S " + D1_S);
            }

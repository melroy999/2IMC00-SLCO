...
vercors_control_node_method_template = env.get_template(
    "vercors_structure/statements/vercors_statement_wrapper_method.jinja2template"
)
vercors_assignment_template = env.get_template(
    "vercors_structure/statements/vercors_assignment.jinja2template"
)
vercors_expression_template = env.get_template(
    "vercors_structure/statements/vercors_expression.jinja2template"
)
vercors_expression_if_statement_template = env.get_template(
    "vercors_structure/statements/vercors_expression_if_statement.jinja2template"
)
vercors_composite_template = env.get_template(
    "vercors_structure/statements/vercors_composite.jinja2template"
)
vercors_permissions_template = env.get_template(
    "vercors_structure/util/vercors_permissions.jinja2template"
)
vercors_lock_verification_contract_statements_template = env.get_template(
    "vercors_structure/util/vercors_lock_verification_contract_statements.jinja2template"
)

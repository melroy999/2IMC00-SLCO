...
// [ one bit reserved, state p'REC1: 1 bit(s), variable p'x: 32 bit(s), variable p'y: 30 bit(s) ],
// Combined with a non-leaf vector tree node: [ variable p'y: 2 bit(s) ]
